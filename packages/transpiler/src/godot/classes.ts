...
export const GODOT_CLASSES = new Set([
  ...
  'ScrollContainer', 'TabContainer', 'SplitContainer',
  'TextureRect', 'ColorRect', 'NinePatchRect',
  'ProgressBar', 'SpinBox', 'Slider', 'HSlider', 'VSlider',
  'CheckBox', 'CheckButton', 'OptionButton', 'MenuButton',
  'Tree', 'ItemList', 'RichTextLabel',
  ...
  'CSGShape3D', 'CSGBox3D', 'CSGSphere3D', 'CSGCylinder3D',
