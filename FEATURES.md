# ts2cs-transpiler Feature Reference

A complete reference of all TypeScript to C# transpilations supported by ts2cs-transpiler, organized by category. Each example includes the test name for easy lookup.
